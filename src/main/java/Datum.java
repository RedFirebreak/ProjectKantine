public class Datum {
	...
	/**
	 * Een lege constructor. Als de klasse hierdoor opgevraagd wordt, worden dag,
	 * maand en jaar op 0 gezet.
	 */
	public Datum() {
		dag = 0;
		maand = 0;
	 ...
	 * 
	 * De dag moet tussen 1-31 liggen en mag niet null zijn. De maand moet tussen
	 * 1-12 liggen en mag niet null zijn. Het jaar moet tussen 1900-2100 liggen en
	 * mag niet null zijn.
	 * 
	 * Maand 1, 3, 5, 7, 8, 10 en 12 hebben altijd maximaal 31 dagen. Maand 4, 6, 9
	 * en 11 hebben altijd maximaal 30 dagen.
	 * 
	 * Maand 2 is een speciale maand. Normaal heeft deze een maximaal 28 dagen. In
	 * een schrikkeljaar (jaar kan door 4 gedeeld worden zonder een rest) is maand 2
	 * maximaal 29 dagen. In een jaar dat deelbaar is door 100, is het geen
	 * schrikkeljaar. Als het jaar dat deelbaar is door 100, ook deelbaar is door
	 * 400, is het WEL een schrikkeljaar.
	 * 
	...
	public boolean bestaatDatum(int dag, int maand, int jaar) {
		// Check of de dag tussen 1 en 31 is.
		if (dag < 1 || dag > 31) {
			return false;
		}

		// Check of de maand tussen 1 en 12 is.
		if (maand < 1 || maand > 12) {
			return false;
		}

		// Check of het jaar tussen de 1900 en 2100 is.
		...
		// Check of maand 2 meer dan 29 dagen heeft.
		if (maand == 2 && dag > 29) {
			return false;
		}
	 ...
	 * 
	 * De dag moet tussen de 1-31 liggen, of tussen 1-30, of tussen 1-29, of tussen
	 * 1-28, maar mag nooit null zijn. Dit ligt allemaal aan welke maand en welk
	 * jaar het is, zie bestaatDatum() voor meer informatie.
	 * 
	 * @param dag De dag voor de datum.
	 */
